...
public class AbbrInfo implements org.apache.thrift.TBase<AbbrInfo, AbbrInfo._Fields>, java.io.Serializable, Cloneable, Comparable<AbbrInfo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AbbrInfo");
  ...
  private static final org.apache.thrift.protocol.TField IMAGE_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("image_name", org.apache.thrift.protocol.TType.STRING, (short)5);
  private static final org.apache.thrift.protocol.TField ITEM_TYPE_FIELD_DESC = new org.apache.thrift.protocol.TField("item_type", org.apache.thrift.protocol.TType.STRING, (short)6);
  private static final org.apache.thrift.protocol.TField ITEM_POSITION_FIELD_DESC = new org.apache.thrift.protocol.TField("item_position", org.apache.thrift.protocol.TType.STRING, (short)7);
  ...
  private static final org.apache.thrift.protocol.TField LOST_TIME_FIELD_DESC = new org.apache.thrift.protocol.TField("lost_time", org.apache.thrift.protocol.TType.I64, (short)9);
  private static final org.apache.thrift.protocol.TField ITEM_DESC_FIELD_DESC = new org.apache.thrift.protocol.TField("item_desc", org.apache.thrift.protocol.TType.STRING, (short)10);
  ...
  private static final org.apache.thrift.protocol.TField CONTACT_FIELD_DESC = new org.apache.thrift.protocol.TField("contact", org.apache.thrift.protocol.TType.STRING, (short)12);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new AbbrInfoStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new AbbrInfoTupleSchemeFactory();
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    IMAGE_NAME((short)5, "image_name"),
    ITEM_TYPE((short)6, "item_type"),
    ITEM_POSITION((short)7, "item_position"),
    STATUS((short)8, "status"),
    LOST_TIME((short)9, "lost_time"),
    ITEM_DESC((short)10, "item_desc"),
    DATE((short)11, "date"),
    CONTACT((short)12, "contact");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AbbrInfo.class, metaDataMap);
  }
   ...
   */
  public AbbrInfo(AbbrInfo other) {
  ...
  @Override
  public AbbrInfo deepCopy() {
    return new AbbrInfo(this);
  }
  ...
  public AbbrInfo setPost_id(@org.apache.thrift.annotation.Nullable String post_id) {
    this.post_id = post_id;
    return this;
  }
  ...
  public AbbrInfo setStudent_id(@org.apache.thrift.annotation.Nullable String student_id) {
    this.student_id = student_id;
    return this;
  }
  ...
  public AbbrInfo setFor_lost_item(boolean for_lost_item) {
    this.for_lost_item = for_lost_item;
    setFor_lost_itemIsSet(true);
    return this;
  }
  ...
  public AbbrInfo setThumbnail(byte[] thumbnail) {
    this.thumbnail = thumbnail == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(thumbnail.clone());
    return this;
  }

  public AbbrInfo setThumbnail(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer thumbnail) {
    this.thumbnail = org.apache.thrift.TBaseHelper.copyBinary(thumbnail);
    return this;
  }
  ...
  public AbbrInfo setImage_name(@org.apache.thrift.annotation.Nullable String image_name) {
    this.image_name = image_name;
    return this;
  }
  ...
  public AbbrInfo setItem_type(@org.apache.thrift.annotation.Nullable String item_type) {
    this.item_type = item_type;
    return this;
  }
  ...
  public AbbrInfo setItem_position(@org.apache.thrift.annotation.Nullable String item_position) {
    this.item_position = item_position;
    return this;
  }
  ...
  public AbbrInfo setStatus(boolean status) {
    this.status = status;
    setStatusIsSet(true);
    return this;
  }
  ...
  public AbbrInfo setLost_time(long lost_time) {
    this.lost_time = lost_time;
    setLost_timeIsSet(true);
    return this;
  }
  ...
  public AbbrInfo setItem_desc(@org.apache.thrift.annotation.Nullable String item_desc) {
    this.item_desc = item_desc;
    return this;
  }
  ...
  public AbbrInfo setDate(long date) {
    this.date = date;
    setDateIsSet(true);
    return this;
  }
  ...
  public AbbrInfo setContact(@org.apache.thrift.annotation.Nullable String contact) {
    this.contact = contact;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that instanceof AbbrInfo)
      return this.equals((AbbrInfo)that);
    return false;
  }

  public boolean equals(AbbrInfo that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(AbbrInfo other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AbbrInfo(");
    boolean first = true;
  ...
  private static class AbbrInfoStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public AbbrInfoStandardScheme getScheme() {
      return new AbbrInfoStandardScheme();
    }
  }

  private static class AbbrInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<AbbrInfo> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, AbbrInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, AbbrInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class AbbrInfoTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public AbbrInfoTupleScheme getScheme() {
      return new AbbrInfoTupleScheme();
    }
  }

  private static class AbbrInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<AbbrInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AbbrInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AbbrInfo struct) throws org.apache.thrift.TException {
